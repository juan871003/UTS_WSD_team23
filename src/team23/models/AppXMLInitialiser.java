...
public class AppXMLInitialiser {
	/*
	 * path and name of the file where the XML is stored, this XML is used to
	 * store the data: Creators, polls, and responses
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		// poll1 - pollresponse1
		Poll poll1 = new Poll(UUID.randomUUID(), "poll 1", new GregorianCalendar(2016, 4, 15).getTime(), "location 1",
				"description 1", "open", possibleMeetingDates1, allResponses1);
		creator1.addPoll(poll1);

		// poll2 - pollresponse2
		Poll poll2 = new Poll(UUID.randomUUID(), "poll 2", new GregorianCalendar(2016, 5, 1).getTime(), "location 2",
				"description 2", "open", possibleMeetingDates2, allResponses2);
		creator2.addPoll(poll2);

		// poll3 - pollresponse3
		Poll poll3 = new Poll(UUID.randomUUID(), "poll 3", new GregorianCalendar(2016, 4, 28).getTime(), "location 3",
				"description 3", "open", possibleMeetingDates3, allResponses3);
